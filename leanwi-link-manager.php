...
function leanwi_lm_update_check() {
    $current_version = get_option('leanwi_link_manager_version', '0.1.0'); // Default to an old version if not set
    $new_version = '0.1.5'; // Update this with the new plugin version
